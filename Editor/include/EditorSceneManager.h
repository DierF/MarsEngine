...
namespace MarsEngine
{
    ...
    public:
        size_t   updateCursorOnAxis(Math::Vec2 cursor_uv,
                                    Math::Vec2 game_engine_window_size);
        ...
        size_t getGuidOfPickedMesh(Math::Vec2 const& picked_uv) const;

    public:
        std::shared_ptr<RenderCamera> getEditorCamera() { return m_camera; };

        GObjectID getSelectedObjectID() { return m_selected_gobject_id; };
        Math::Mat4 getSelectedObjectMatrix() { return m_selected_object_matrix; }
        ...
        void setSelectedObjectMatrix(Math::Mat4 new_object_matrix) { m_selected_object_matrix = new_object_matrix; }
    ...
    private:
        ...
        Math::Mat4 m_selected_object_matrix{ Math::Mat4::IDENTITY };
