# 
set(PRECOMPILE_TOOLS_PATH "${CMAKE_CURRENT_SOURCE_DIR}/binprecompile")
set(MARS_PRECOMPILE_PARAMS_IN_PATH "${CMAKE_CURRENT_SOURCE_DIR}/Precompile/Precompile.json.in")
set(MARS_PRECOMPILE_PARAMS_PATH "${PRECOMPILE_TOOLS_PATH}/Precompile.json")
configure_file(${MARS_PRECOMPILE_PARAMS_IN_PATH} ${MARS_PRECOMPILE_PARAMS_PATH})

#
# use wine for linux
if (CMAKE_HOST_WIN32)
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/MarsParser.exe)
    set(sys_include "*") 
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" )
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/MarsParser)
...
set (PARSER_INPUT ${CMAKE_BINARY_DIR}/ParserHeader.h)
### BUILDING ====================================================================================
set(PRECOMPILE_TARGET "MarsPreCompile")
...
COMMAND
    ${PRECOMPILE_PARSER} "${MARS_PRECOMPILE_PARAMS_PATH}"  "${PARSER_INPUT}"  "${ENGINE_ROOT_DIR}" ${sys_include} "MarsEngine" 0
### BUILDING ====================================================================================
COMMAND
