...
namespace Math
{
    ...
    //-----------------------------------------------------------------------
    void Mat3::setColumn(size_t col_index, Vec3 const& vec)
    {
    ...
    //-----------------------------------------------------------------------
    void Mat3::fromAxes(Vec3 const& x_axis, Vec3 const& y_axis, Vec3 const& z_axis)
    {
        setColumn(0, x_axis);
        setColumn(1, y_axis);
        setColumn(2, z_axis);
    ...
    void Mat3::calculateQDUDecomposition(Mat3& out_Q, Vec3& out_D, Vec3& out_U) const
    {
    ...
    void Mat3::toAngleAxis(Vec3& axis, Radian& radian) const
    {
    ...
    //-----------------------------------------------------------------------
    void Mat3::fromAngleAxis(Vec3 const& axis, Radian const& radian)
    {
