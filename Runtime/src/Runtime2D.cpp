...
Runtime2D::Runtime2D()
	: Layer("Runtime2D"), m_cameraController(1920.0f / 1080.0f, true)
{
}

void Runtime2D::onAttach()
{
	ME_PROFILE_FUNCTION();
...
void Runtime2D::onDetach()
{
	ME_PROFILE_FUNCTION();
}

void Runtime2D::onUpdate(MarsEngine::Timestep ts)
{
	ME_PROFILE_FUNCTION();
...
void Runtime2D::onEvent(MarsEngine::Event& e)
{
