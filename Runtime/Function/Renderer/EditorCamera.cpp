...
#include "MarsEngine/Core/MouseButtonCode.h"
...
namespace MarsEngine
{
	...
	void EditorCamera::onUpdate(Timestep ts)
	{
		if (Input::isKeyPressed(ME_KEY_LEFT_ALT))
		{
			...
			if (Input::isMouseButtonPressed(ME_MOUSE_BUTTON_MIDDLE))
				...
				mouseRotate(delta);
			else if (Input::isMouseButtonPressed(ME_MOUSE_BUTTON_RIGHT))
				mouseZoom(delta.y);
		}
	...
	void EditorCamera::onEvent(Event& e)
	{
		...
		dispatcher.dispatch<MouseScrolledEvent>(ME_BIND_EVENT_FUNC(EditorCamera::onMouseScroll));
	}
