#include "Runtime/Function/Framework/Component/Lua/LuaComponent.h"
...
namespace MarsEngine
{
    ...
    template<typename T>
    void LuaComponent::set(std::weak_ptr<GObject> game_object, char const* name, T value)
    {
        LOG_INFO(name);
        Reflection::FieldAccessor field_accessor;
        void*                     target_instance;
    ...
    template<typename T>
    T LuaComponent::get(std::weak_ptr<GObject> game_object, char const* name)
    {
    ...
    void LuaComponent::invoke(std::weak_ptr<GObject> game_object, char const* name)
    {
        LOG_INFO(name);
