...
{
    void ColorGradingPass::initialize(RenderPassInitInfo const* init_info)
    {
        RenderPass::initialize(nullptr);

        ColorGradingPassInitInfo const* _init_info = static_cast<ColorGradingPassInitInfo const*>(init_info);
