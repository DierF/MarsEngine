...
{
    void MainCameraPass::initialize(RenderPassInitInfo const* init_info)
    {
        RenderPass::initialize(nullptr);

        MainCameraPassInitInfo const* _init_info = static_cast<MainCameraPassInitInfo const*>(init_info);
