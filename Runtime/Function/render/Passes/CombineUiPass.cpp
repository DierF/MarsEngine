...
{
    void CombineUIPass::initialize(RenderPassInitInfo const* init_info)
    {
        RenderPass::initialize(nullptr);

        CombineUIPassInitInfo const* _init_info = static_cast<CombineUIPassInitInfo const*>(init_info);
