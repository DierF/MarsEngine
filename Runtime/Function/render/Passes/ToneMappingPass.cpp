...
{
    void ToneMappingPass::initialize(RenderPassInitInfo const* init_info)
    {
        RenderPass::initialize(nullptr);

        ToneMappingPassInitInfo const* _init_info = static_cast<ToneMappingPassInitInfo const*>(init_info);
