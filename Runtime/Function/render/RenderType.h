...
namespace MarsEngine
{
    enum class MARS_IMAGE_TYPE : uint8_t
    {
        MARS_IMAGE_TYPE_UNKNOWM = 0,
        MARS_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        MARS_IMAGE_TYPE   m_type { MARS_IMAGE_TYPE::MARS_IMAGE_TYPE_UNKNOWM};
    ...
    struct MeshSourceDesc
    {
        ...
        bool   operator==(MeshSourceDesc const& rhs) const { return m_mesh_file == rhs.m_mesh_file; }
    ...
    struct MaterialSourceDesc
    {
        ...
        bool operator==(MaterialSourceDesc const& rhs) const
        {
...
template<>
struct std::hash<MarsEngine::MeshSourceDesc>
{
    size_t operator()(MarsEngine::MeshSourceDesc const& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<MarsEngine::MaterialSourceDesc>
{
    size_t operator()(MarsEngine::MaterialSourceDesc const& rhs) const noexcept { return rhs.getHashValue(); }
};
