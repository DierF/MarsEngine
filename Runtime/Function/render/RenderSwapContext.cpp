...
namespace MarsEngine
{
    ...
    ParticleEmitterDesc const& ParticleSubmitRequest::getEmitterDesc(unsigned int index)
    {
    ...
    ParticleEmitterTransformDesc const& EmitterTransformRequest::getNextEmitterTransformDesc(unsigned int index)
    {
