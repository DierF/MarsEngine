#include "Runtime/Function/Render/DebugDraw/DebugDrawPipeline.h"
...
namespace MarsEngine
{
    ...
    {
        std::vector<RHIImageView*> const&& imageViews = m_rhi->getSwapchainInfo().imageViews;
    ...
    DebugDrawPipelineBase const& DebugDrawPipeline::getPipeline() const
    {
        return m_render_pipelines[0];
    }

    DebugDrawFramebuffer const& DebugDrawPipeline::getFramebuffer() const
    {
