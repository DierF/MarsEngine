...
#include "Resource/ResType/Data/SkeletonMask.h"
...
namespace MarsEngine
{
    ...
    BlendStateWithClipData AnimationManager::getBlendStateWithClipData(BlendState const& blend_state)
    {
        ...
        for (auto const& iter : blend_state.blend_clip_file_path)
        {
            blend_state_with_clip_data.blend_clip.push_back(*m_animation_data_cache[iter]);
        }
        for (auto const& iter : blend_state.blend_anim_skel_map_path)
        {
