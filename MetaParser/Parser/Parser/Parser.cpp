...
MetaParser::MetaParser(std::string const project_input_file,
                       std::string const include_file_path,
                       std::string const include_path,
                       std::string const sys_include,
...
void MetaParser::buildClassAST(Cursor const& cursor, Namespace& current_namespace)
{
